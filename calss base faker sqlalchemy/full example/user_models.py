...
class UsrUserMerchant(Base):
    ...
    id = Column(Integer, primary_key=True, index=True,
                server_default=text("nextval('usr_user_merchants_id_seq'::regclass)"))
...
class UsrUserGroups(Base):
    ...
    deleted_at = Column(DateTime)
    id = Column(Integer, primary_key=True, index=True,
                server_default=text("nextval('usr_user_groups_id_seq'::regclass)"))
    user_id = Column(ForeignKey('usr_user.id'), nullable=False)
...
class UsrGroupScope(Base):
    ...
    deleted_at = Column(DateTime)
    id = Column(Integer, primary_key=True, index=True,
                server_default=text("nextval('usr_group_scopes_id_seq'::regclass)"))
    group_id = Column(ForeignKey('usr_group.id'), nullable=False)
